				...
				$.ajax({
					...
					success: function(data) {
						...
						$.each(data, function(i, item){
							userInfo = "用户id：" + userId + "，系统编号：" + item.id + "，用户名：" + item.userName;
						)};
			...
			$("#btnGetUserList").click(function(){
				...
				$.ajax({
					...
					success: function(data) {
						var userInfo = "";
						$.each(data, function(i, item){
							userInfo += "用户id：" + userId + "，系统编号：" + item.id + "，用户名：" + item.userName + "，注册时间：" + item.onTime + "<br/>";
						)};
...
<body>
	...
	<p><input type="text" id="txtSysId"><span style="cursor: pointer;" id="btnGetUserName">根据系统编号查询用户名</span></p>

	<p>输入用户id（比如zhangsan/lisi）：</p>
	<p><input type="text" id="txtUserId"><span style="cursor: pointer;" id="btnGetUserInfo">根据用户id查询用户信息</span></p>
	<div id="txtUserInfo"></div>
	
	<p><span style="cursor: pointer;" id="btnGetUserList">查询所有用户信息</span></p>
